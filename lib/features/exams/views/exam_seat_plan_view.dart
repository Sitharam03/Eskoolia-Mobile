...
class ExamSeatPlanView extends StatelessWidget {
  const ExamSeatPlanView({super.key});

  ExamSeatPlanController get _c => Get.find<ExamSeatPlanController>();
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      ...
      body: Column(
        children: [
          const ExamNavTabs(activeRoute: AppRoutes.examSeatPlan),
          Expanded(
            child: Obx(() {
...
class _SearchCard extends StatelessWidget {
  final ExamSeatPlanController c;
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        SizedBox(
          ...
          child: Obx(() => ElevatedButton.icon(
                ...
                label: Text(
                    c.isGenerating.value ? 'Generating…' : 'Generate Seat Plan',
                    style: GoogleFonts.inter(fontWeight: FontWeight.w600)),
                style: ElevatedButton.styleFrom(
    ...
    return Obx(() {
      ...
      return Container(
        ...
        child: Row(children: [
          ...
          if (isOld) sBadge('Assigned', const Color(0xFF0EA5E9)),
        ]),
      );
    });
  }
